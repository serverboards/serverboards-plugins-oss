...
var EditSecret=React$4.createClass({displayName:"EditSecret",handleEncrypt:function handleEncrypt(){var _this=this,a=$(this.refs.content).val(),b=$(this.refs.password).val(),c=$(this.refs.title).val();if(!b)return void Flash$2.error("Cant use empty password.");if(6>b.length)return void Flash$2.error("Password too short! At least 6 characters.");if(b!=$(this.refs.password_repeat).val())return void Flash$2.error("Passwords do not match!");var d={text:a,files:this.props.files||[]},e=[];// Maybe some promises if there are selected files
if(0<this.refs.upload.files.length){var _iteratorNormalCompletion=!0,_didIteratorError=!1,_iteratorError=void 0;try{var _loop=function _loop(){var g=_step.value,h=new Promise(function(i,j){var k=new FileReader;k.onload=function(l){d.files.push({name:g.name,data:l.target.result,size:g.size}),i()},k.readAsDataURL(g)});console.log(e),e.push(h)};for(var _step,_iterator=this.refs.upload.files[Symbol.iterator]();!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=!0)_loop()}catch(err){_didIteratorError=!0,_iteratorError=err}finally{try{!_iteratorNormalCompletion&&_iterator.return&&_iterator.return()}finally{if(_didIteratorError)throw _iteratorError}}}Promise.all(e).then(function(){var g=JSON.stringify(d),h=crypto.encrypt(b,g);_this.props.onSave(c,h)})},render:function render(){var a=this.props;return React$4.createElement("div",{className:"ui text container"},React$4.createElement("div",{ref:"el",className:"ui form"},React$4.createElement("div",{className:"field"},React$4.createElement("label",null,"Secret Name"),React$4.createElement("input",{type:"text",ref:"title",defaultValue:a.title})),React$4.createElement("div",{className:"field"},React$4.createElement("label",null,"Text"),React$4.createElement("textarea",{id:"plain",ref:"content",style:{minHeight:"calc( 100vh - 33em )"},defaultValue:a.content})),React$4.createElement("div",{className:"field"},React$4.createElement("label",null,"Uploads"),React$4.createElement("input",{type:"file",ref:"upload"}),React$4.createElement("span",null,"Has ",(this.props.files||[]).length," attachments")),React$4.createElement("div",{className:"inline field"},React$4.createElement("label",null,"Password: "),React$4.createElement("input",{type:"password",defaultValue:a.password,ref:"password"}),React$4.createElement("label",null,"\xA0Repeat Password: "),React$4.createElement("input",{type:"password",defaultValue:a.password,ref:"password_repeat"}),"\xA0",React$4.createElement("button",{className:"ui button yellow",onClick:this.handleEncrypt},"Encrypt"))))}});
...
function PreviewFile(a){var b=a.data.slice(5,a.data.indexOf(';'));switch(console.log(a.data.slice(0,20),b),b){case'image/gif':case'image/svg':case'image/png':case'image/jpg':case'image/jpeg':return React$2.createElement('img',{src:a.data,className:'ui top aligned avatar image'});}return preseticons[b]?React$2.createElement('i',{style:icon_style,className:'icon big black '+preseticons[b]}):(b=b.slice(b.indexOf('/')),preseticons[b]?React$2.createElement('i',{style:icon_style,className:'icon big black '+preseticons[b]}):React$2.createElement('i',{style:icon_style,className:'icon big black file'}))}var ViewSecret=React$2.createClass({displayName:'ViewSecret',getInitialState:function getInitialState(){return{text:void 0,password:void 0,files:[],edit:!1}},handleOpenEdit:function handleOpenEdit(){this.setState({edit:!0})},handlePasswordSet:function handlePasswordSet(a){try{var b=JSON.parse(crypto.decrypt(a,this.props.secret));this.setState({text:b.text,password:a,files:b.files||[]}),this.props.onSecretVisible(!0)}catch(b){console.error(b),Flash$1.error('Invalid password. Try again.')}},componentWillReceiveProps:function componentWillReceiveProps(a){a.secret!=this.props.secret&&this.setState(this.getInitialState())},render:function render(){var a=this.state;return a.edit?React$2.createElement(EditSecret,{password:a.password,content:a.text,title:this.props.title,onSave:this.props.onSave,files:this.state.files}):a.password?React$2.createElement('div',{className:'ui text container'},React$2.createElement(MarkdownPreview,{value:a.text}),React$2.createElement('div',{className:'ui divider'}),0<a.files.length?React$2.createElement('div',null,'Attachments:',React$2.createElement('div',{className:'ui three column grid'},a.files.map(function(b){return React$2.createElement('a',{href:b.data,target:'_blank',download:b.name,key:b.name,className:'column'},React$2.createElement(PreviewFile,b),React$2.createElement('div',{style:{display:'inline-block'}},React$2.createElement('div',null,b.name),React$2.createElement('div',{className:'ui meta'},b.size||'~ '+3*b.data.length/4,' bytes')))})),React$2.createElement('div',{className:'ui divider'})):null,React$2.createElement('button',{style:{float:'right'},className:'ui button yellow',onClick:this.handleOpenEdit},'Edit')):React$2.createElement(RequestPassword,{onPasswordSet:this.handlePasswordSet})}});
