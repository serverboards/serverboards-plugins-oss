...
function sorted(a){return a.sort(),a}var Header=React$1.createClass({displayName:'Header',componentDidMount:function componentDidMount(){$(this.refs.secret_select).dropdown({})},handleSecretSelect:function handleSecretSelect(a){a.target.value&&this.props.onSecretSelect(a.target.value)},componentWillReceiveProps:function componentWillReceiveProps(a){var _this=this;a.secret!=this.props.secret&&setTimeout(function(){a.secret?$(_this.refs.secret_select).dropdown('set selected',a.secret):$(_this.refs.secret_select).dropdown('clear')},20)},render:function render(){var a=this.props;return React$1.createElement('div',{className:'ui top secondary menu'},a.show_title?React$1.createElement('h3',{className:'ui header'},a.title||'Select Secret'):null,React$1.createElement('div',{className:'right menu'},a.onDelete?React$1.createElement(HoldButton,{className:'ui outline button red',onHoldClick:a.onDelete},'Hold to remove'):null,React$1.createElement('select',{className:'ui dropdown search small',name:'secret',ref:'secret_select',onChange:this.handleSecretSelect,value:a.secret},React$1.createElement('option',{value:''},'Select a secret'),sorted(Object.keys(a.secrets)).map(function(b){return React$1.createElement('option',{key:b,value:b},a.secrets[b])})),React$1.createElement('a',{className:'item',onClick:a.onSecretAdd},React$1.createElement('i',{className:'ui icon add'}))))}});
...
var View=React.createClass({displayName:'View',getInitialState:function getInitialState(){return{secrets:{},title:void 0,secret:void 0,secret_id:void 0,add:!1,visible:!1}},componentDidMount:function componentDidMount(){var _this=this;rpc.call('plugin.data.list',[plugin_id,this.props.project+'.']).then(function(a){var b={},c=_this.props.project.length+1;a.map(function(d){b[d]=d.slice(c)}),_this.setState({secrets:b}),_this.state.secret_id&&_this.handleSecretSelect(_this.state.secret_id)}),this.props.setSectionMenu&&this.props.setSectionMenu(this.render_header)},handleSecretSelect:function handleSecretSelect(a){var _this2=this;console.log('secret %o',a),rpc.call('plugin.data.get',[plugin_id,a]).then(function(b){_this2.setState({secret:b,title:_this2.state.secrets[a],secret_id:a,add:!1,visible:!1})})},handleAddSecretDialog:function handleAddSecretDialog(){this.setState({add:!0,title:'Add a new secret',secret_id:void 0})},handleAddSecret:function handleAddSecret(a,b){var _this3=this,c=this,d=this.props.project+'.'+a;rpc.call('plugin.data.update',[plugin_id,d,b]).then(function(f){console.log('Saved encrypted data: %o: %o',a,f);var g=utils.merge(_this3.state.secrets,defineProperty({},d,a));c.setState({add:!1,secret:b,title:a,secrets:g,secret_id:d})}).catch(function(f){console.error(f),Flash.error('Could not save encrypted secret')})},handleDeleteSecret:function handleDeleteSecret(){var _this4=this,a=this.state.secret_id;rpc.call('plugin.data.delete',[plugin_id,a]).then(function(){console.log('Deleted secret %o',a);var b={};Object.keys(_this4.state.secrets).map(function(c){c!=a&&(b[c]=_this4.state.secrets[c])}),_this4.setState({secret_id:void 0,secrets:b,secret:void 0,title:void 0,visible:!1})})},handleTitleChange:function handleTitleChange(a,b,c){var _this5=this,d={};Object.keys(this.state.secrets).map(function(f){f==a?d[b]=c:d[f]=_this5.state.secrets[f]}),this.setState({secret_id:b,secrets:d,title:c})},handleSecretVisible:function handleSecretVisible(){var a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:!0;this.setState({visible:a})},handleSave:function handleSave(a,b){var _this6=this;rpc.call('plugin.data.update',[plugin_id,this.props.project+'.'+a,b]).then(function(){if(a!=_this6.state.title)// remove old one
return rpc.call('plugin.data.delete',[plugin_id,_this6.props.project+'.'+_this6.state.title])}).then(function(){return _this6.reload(_this6.props.project+'.'+a)}).catch(function(c){console.error(c),Flash.error('Error saving secret')})},reload:function reload(){var a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:void 0;this.setState(this.getInitialState()),this.setState({secret_id:a}),this.componentDidMount()},render_header:function render_header(a){var b=this.state;return React.createElement(Header,{secrets:b.secrets,title:b.title,secret:b.secret_id,onSecretSelect:this.handleSecretSelect,onSecretAdd:this.handleAddSecretDialog,onDelete:b.visible&&this.handleDeleteSecret,show_title:a})},render:function render(){var a=this.props,b=this.state;return React.createElement('div',{id:'secrets'},a.setSectionMenu?null:this.render_header(!0),b.add?React.createElement(EditSecret,{onSave:this.handleAddSecret}):b.secret?React.createElement(ViewSecret,{secret:b.secret,title:b.title,onSave:this.handleSave,onSecretChange:b.handleSecretSelect,onSecretVisible:this.handleSecretVisible,reload:this.reload}):React.createElement('div',{className:'ui text container'},'No secret selected. Select a secret from the top menu or add one.'))}});function main(a,b,c){return console.log('secrets config:',b,c),Serverboards.ReactDOM.render(React.createElement(View,{project:b.project.shortname,setSectionMenu:c.setSectionMenu}),a),function(){Serverboards.ReactDOM.unmountComponentAtNode(a)}}Serverboards.add_screen(plugin_id+'/screen',main);
