...
(function(){
  ...
  function main(_el){
    ...
    try{
      ...
      Serverboards.plugin.start("serverboards.google.drive/daemon").then( function(drive){
        return drive.call("store_code", [service_id, code])
      }).then( function(){
  ...
  Serverboards.add_screen("serverboards.google.drive/auth", main)
})()
