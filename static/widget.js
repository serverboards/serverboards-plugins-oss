...
for(var a=Math.floor(Math.sqrt(120*(280*(this.props.layout.width*this.props.layout.height))/this.state.services.length)),b=!1,c=void 0,d=void 0,e=void 0;!b&&(c=Math.floor(280*this.props.layout.width/a),e=Math.floor(120*this.props.layout.height/a),d=Math.ceil(this.state.services.length/c),b=d<=e,b||(a-=1),!(20>a));)// iNan!!
