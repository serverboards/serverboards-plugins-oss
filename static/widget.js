...
function TimelineLine(_ref){var a=_ref.expiration,b=_ref.service,c=_ref.onClick,d=_ref.hasDivider,f=_ref.showCalendar,g=moment(a.date),h=g.isBefore(moment()),i={paddingLeft:5,paddingBottom:"1rem",cursor:"pointer"};return d&&(i.borderTop="1px solid #eee",i.paddingTop="1rem"),React$1.createElement("div",{className:"row",key:a.service+"/"+a.name+"/"+a.date+"/"+a.id,"data-tooltip":a.name+"\n"+(a.description||""),"data-date":g.format("YYYY-MM-DD"),style:i,onClick:function onClick(){return f(g.year(),g.month())}},React$1.createElement("div",null,React$1.createElement("a",{onClick:function onClick(j){return c()&&j.stopPropagation()}},React$1.createElement("b",null,b.name))," - ",g.fromNow()),React$1.createElement("div",{className:h?"ui text red":""},h?"Expired":"Expires"," on ",g.format("MMM Do, YY")))}var Timeline=React$1.createClass({displayName:"Timeline",getInitialState:function getInitialState(){var a={},b=moment();a[b.format("YYYY-MM-DD")]="bold text teal";var _iteratorNormalCompletion=!0,_didIteratorError=!1,_iteratorError=void 0;try{for(var _step,_iterator=this.props.expirations[Symbol.iterator]();!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=!0){var c=_step.value;a[moment(c.date).format("YYYY-MM-DD")]="background light grey"}}catch(err){_didIteratorError=!0,_iteratorError=err}finally{try{!_iteratorNormalCompletion&&_iterator.return&&_iterator.return()}finally{if(_didIteratorError)throw _iteratorError}}return{marks:a}},gotoDate:function gotoDate(a){a=a.format("YYYY-MM-DD");var b=$(this.refs.list).find("[data-date=\""+a+"\"]:first"),c=b.parent(),d=b.offset().top-c.offset().top+c.scrollTop();c.scrollTop(d)},showCalendar:function showCalendar(a,b){this.setState({year:a,month:b})},render:function render(){var _this=this,_props=this.props,a=_props.expirations,b=_props.onShowService,c=_props.getServiceByUUID,d=_props.maxHeight,f=this.state;return React$1.createElement("div",null,React$1.createElement(Calendar,{marks:f.marks,navigation:!0,onClick:this.gotoDate,month:this.state.month,year:this.state.year}),React$1.createElement("div",{ref:"list",className:"ui vertically divided list",style:{overflow:"auto",maxHeight:d}},a.map(function(g,h){return React$1.createElement(TimelineLine,{expiration:g,service:c(g.service),onClick:function onClick(){return b(g.service)},hasDivider:0!=h,showCalendar:_this.showCalendar})})))}});
