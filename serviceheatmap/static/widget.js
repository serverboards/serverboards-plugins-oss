...
for(var b=a.layout,c=Math.floor(Math.sqrt((b.width-10)*(b.height-55)/this.state.services.length)),d=!1,e=void 0,f=void 0,g=void 0;!d&&(e=Math.floor(b.width/c),g=Math.floor(b.height/c),f=Math.ceil(this.state.services.length/e),d=f<=g,d||(c-=1),!(20>c));)if(c!=c){console.error("Error calculating size! NaN"),c=30;// A default size
